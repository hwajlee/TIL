...
# BERT_MODEL = tensorflow.keras.models.load_model('models/bert_initial_v1.h5')
# @ views.py
# import settings
# prediction = settings.BERT_MODEL.predict(~~~)

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-$nh5&k^4bkm)3^lgxtliz+1zkv)4u^$-6o@d72q9!8fre7a-1f'
...
TIME_ZONE = 'Asia/Seoul' # ex. 글 등록시 기준되는 시간
